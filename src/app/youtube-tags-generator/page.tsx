    ...
    <main className="container mx-auto px-6 py-12 max-w-4xl relative z-10 min-h-screen">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-6 md:p-8 mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => copy(tags.join(', '), 'all-tags')} className="copy-btn">
                {copiedStates['all-tags'] ? <><CheckCircle2 className="w-4 h-4 text-green-400" /> Copied!</> : <><Copy className="w-4 h-4 text-gray-400" /> Copy All</>}
              </button>
            </div>
            {/* Character limit bar */}
      ...
      <section className="mt-12 space-y-8">
        ...
        <div className="text-gray-400 leading-relaxed space-y-4">
          <p>While YouTube has said tags are a minor ranking factor, they still play a key role in <strong className="text-white">helping the algorithm categorize your content</strong> and serving it to the right audience through related/suggested videos.</p>
        ...
        <div className="glass-card rounded-2xl p-6 text-center">
          <p className="text-gray-400 mb-4">Need titles, descriptions, and hashtags too?</p>
