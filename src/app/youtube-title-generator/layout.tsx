...
export const metadata: Metadata = {
  title: 'Free YouTube Title Generator — AI-Powered | TubeBoost',
  ...
  openGraph: {
    ...
    url: 'https://tubeboost.com/youtube-title-generator',
    type: 'website',
  },
  alternates: { canonical: 'https://tubeboost.com/youtube-title-generator' },
};
