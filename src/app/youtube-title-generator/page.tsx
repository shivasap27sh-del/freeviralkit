    ...
    <main className="container mx-auto px-6 py-12 max-w-4xl relative z-10 min-h-screen">
        ...
        {titles.length > 0 && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-6 md:p-8 mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={handleGenerate} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-sm text-gray-400 hover:text-white transition-colors">
            ...
            <button onClick={() => copy(titles.join('\n'), 'all-titles')} className="mt-4 w-full py-3 rounded-xl bg-white/5 border border-white/10 text-sm font-medium text-gray-400 hover:text-white hover:bg-white/10 transition-all">
      ...
      <section className="mt-12 space-y-8">
        ...
        <div className="text-gray-400 leading-relaxed space-y-4">
          ...
          <p>A great YouTube title should be <strong className="text-white">50-70 characters</strong>, include your primary keyword, use power words that trigger curiosity, and match the search intent of your target audience.</p>
        ...
        <div className="glass-card rounded-2xl p-6 text-center">
          <p className="text-gray-400 mb-4">Need the full SEO package? Get titles + descriptions + hashtags + tags all at once.</p>
