...
2. Sort your videos by **Average View Duration** (not views)
3. Look at your top 10 videos by AVD
4. Ask yourself: what do these videos have in common?
...
Ready to turn those insights into action? Use our free [YouTube Shorts Idea Generator](/youtube-shorts-idea-generator) to come up with fresh, high-performing short-form video ideas based on what your analytics already proved works. Stop guessing, start creating.`,
publishDate: "2026-05-29",
  date: "2026-05-29",
  readTime: "9 min read",
  category: "Analytics",
  tags: ["youtube analytics", "youtube studio", "video metrics", "youtube data", "channel analytics"]
};
