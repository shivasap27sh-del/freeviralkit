...
export const post: BlogPost = {
  "slug": "youtube-topic-research-strategies",
  "title": "YouTube Topic Research: How I Stopped Wasting Weeks on Videos Nobody Watched",
  "description": "I used to spend 20+ hours filming videos that got zero views. Here is the personal topic research system I developed to find high-demand, low-competition ideas.",
  "content": `## The Heartbreak of 0 Views
...
## The Competitor Analysis Strategies That Changed Everything
...
## My Topic Validation Checklist

Before I film any video, I run the topic through this validation checklist to make sure it is worth my time.

| Criteria | High Priority (Make the Video) | Low Priority (Skip for Now) |
|---|---|---|
| **Search Interest** | Rising search trends on Google Trends (YouTube Search filter). | Declining interest or dead trends. |
| **Competition Level** | Search results contain smaller channels or old videos with low-quality thumbnails. | Search results are dominated by verified channels with millions of subscribers. |
| **Affiliate Potential** | High. I can link to products (e.g., equipment guides) to make money even with small views. | Low. No clear products or sponsorships fit the topic. |
| **Search Intent** | Specific troubleshooting or guides (e.g., *"how to remove microphone echo"*). | Broad, generic terms (e.g., *"microphones"*). |


## Leveraging AI for Rapid Topic Research

Analyzing search trends manually can take hours. Today, I save time by using AI to generate variations and analyze topics. 

I use our free [AI Niche Researcher](/youtube-topic-researcher) to input a general keyword, find low-competition variations, see structural outlines, and plan out my keyword tags. It helps me validate ideas in minutes rather than hours.

When prompting AI, keep it specific and human:
> *"Act as my YouTube SEO coach. I run a gardening channel. Give me 10 specific, long-tail questions that beginners ask about growing tomatoes indoors. I want topics where the competition is low but the search intent is high. Write them in a conversational, helpful tone."*
