...
export const post: BlogPost = {
  slug: "youtube-analytics-metrics-guide",
  title: "Demystifying YouTube Analytics: The Only Metrics That Actually Matter in 2026",
  description: "Stop drowning in data. Learn which YouTube analytics metrics actually trigger the algorithm in 2026, and which vanity metrics are holding your channel back.",
...
**1. The Intro Cliff:** If you are losing 40% to 50% of your audience before the 30-second mark, your intro is broken. 
**2. The Gradual Bleed:** If your graph looks like a steep ski slope, your pacing is off. You need more pattern interrupts—b-roll, text on screen, or dynamic camera angle changes.
**3. The Spikes:** When the graph spikes upward, it means viewers rewound to re-watch a specific moment. Analyze what happened at that exact second and do more of it.
...
Are they staying? (AVD)
Are they coming back? (Returning Viewers)
...
`,
  ...
  tags: ["youtube analytics", "youtube metrics", "ctr", "avd"]
};
