...
export const post: BlogPost = {
  ...
  "title": "YouTube Playlist Strategy: How to Use Playlists to 3x Your Watch Time",
  "description": "Playlists are the most underrated YouTube growth hack. Learn how to structure, optimize, and promote playlists to triple your session watch time and get more views on autopilot.",
  "content": `## The Most Underrated Growth Hack on YouTube
...
A few quick rules:
*   Put your most important keyword at the beginning of the playlist title
*   Write at least 100 words in the playlist description
...
*   **Playlist shelf in search results:** YouTube sometimes shows a horizontal carousel of your playlist videos directly in search results. This takes up a massive amount of screen space compared to a single video result.
*   **Playlist page in search:** Your entire playlist can appear as a single search result, showing the title, number of videos, and a preview of the first few entries.
*   **Suggested playlists on the sidebar:** When someone watches a video related to your playlist topic, YouTube may suggest your entire playlist in the sidebar.
*   **Channel page playlists:** Organized playlists on your channel page make it easier for new visitors to find relevant content and start binge-watching.
