...
export default function DescriptionGeneratorPage() {
  ...
  const examples = ['How To Bake Cake', 'iPhone 16 Review', 'Learn Piano Free', 'Paris Travel Guide'];
      ...
      <div className="glass-card rounded-2xl p-6 md:p-8 mb-8">
        <div className="relative mb-4">
          <input type="text" value={topic} onChange={e => setTopic(e.target.value)}
            placeholder="Enter your video topic or title (e.g. how to bake a chocolate cake, iphone 16 review...)"
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 mb-8">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => copy(description, 'desc')} className="copy-btn cursor-pointer">
                {copiedStates['desc'] ? <><CheckCircle2 className="w-4 h-4 text-green-400" /> Copied!</> : <><Copy className="w-4 h-4 text-slate-600" /> Copy Description</>}
              </button>
            </div>
              ...
              <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24">
                ...
                <div className="glass-card rounded-2xl p-6 border border-slate-200/60 shadow-lg">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-display font-bold text-slate-800">SEO & Structure Score</h3>
                  </div>
                  ...
                  <div className="flex items-center gap-5 mb-5 pb-4 border-b border-slate-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Based on YouTube crawl benchmarks for descriptions.</p>
                    </div>
                  </div>
