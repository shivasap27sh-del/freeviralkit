          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-6 md:p-8 mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <span className="text-xs text-slate-500">{description.split(/\s+/).length} words</span>
              </div>
            ...
            <div className="bg-slate-50 rounded-xl p-5 border border-slate-100">
              <p className="whitespace-pre-wrap text-slate-700 leading-relaxed text-[0.95rem]">{description}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
