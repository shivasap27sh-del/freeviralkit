  ...
  return (
    <main className="container mx-auto px-6 py-12 max-w-3xl relative z-10 min-h-screen">
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed">
        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">1. Introduction</h2>
        ...
        <section>
          ...
          <ul className="space-y-2 ml-4">
            <li><strong className="text-slate-900">Usage Data:</strong> Anonymous statistics like page views and device type.</li>
            <li><strong className="text-slate-900">Input Data:</strong> Video topics you enter are processed by AI but not permanently stored.</li>
            <li><strong className="text-slate-900">Contact Info:</strong> Name, email, and message if you use our contact form.</li>
          </ul>
        </section>

        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">3. Cookies &amp; Tracking</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">4. Google AdSense</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">5. Third-Party Services</h2>
          <ul className="space-y-2 ml-4">
            <li><strong className="text-slate-900">Groq AI:</strong> Processes video topics to generate SEO content.</li>
            <li><strong className="text-slate-900">Google AdSense:</strong> Serves advertisements.</li>
            <li><strong className="text-slate-900">Vercel:</strong> Hosts our website.</li>
          </ul>
        </section>

        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">6. Data Security</h2>
          <p>We implement appropriate security measures. However, no method of internet transmission is 100% secure.</p>
        </section>

        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">7. Your Rights</h2>
          <p>You may access, correct, or delete your data, and opt out of personalized advertising at any time.</p>
        </section>

        <section>
          <h2 className="font-display text-xl font-bold text-slate-900 mb-3">8. Contact</h2>
