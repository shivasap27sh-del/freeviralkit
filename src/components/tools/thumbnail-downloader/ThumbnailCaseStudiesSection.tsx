import { Palette, Layers, Eye, ShieldAlert } from 'lucide-react';

export function ThumbnailCaseStudiesSection() {
  return (
    <section aria-labelledby="deep-guide-heading" className="glass-card rounded-3xl p-8 md:p-12 border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 shadow-xl dark:shadow-2xl space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-slate-700 dark:text-slate-300">
        <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-3">
          <div className="flex items-center gap-2 text-cyan-700 dark:text-cyan-400 font-bold text-base">
        ...
        <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-3">
          <div className="flex items-center gap-2 text-cyan-700 dark:text-cyan-400 font-bold text-base">
            <ShieldAlert className="w-4 h-4 text-amber-500" /> 2. The 160×50px Timestamp Dead Zone
          </div>
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
