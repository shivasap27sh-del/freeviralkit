import { BookOpen, Eye, Target, Sparkles, CheckCircle2 } from 'lucide-react';

export function ThumbnailMasterclassSection() {
  return (
    <section aria-labelledby="guide-heading" className="glass-card rounded-3xl p-8 md:p-12 border border-blue-500/20 bg-slate-900/90 shadow-2xl space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
          ...
          <h3 className="font-bold text-white text-base">1. The 3-Element Visual Rule</h3>
        ...
        <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
          ...
          <h3 className="font-bold text-white text-base">2. Strategic Tag Architecture</h3>
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
          ...
          <h3 className="font-bold text-white text-base">3. YouTube Vision AI Inspection</h3>
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
