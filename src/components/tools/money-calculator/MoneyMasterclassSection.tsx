import { BookOpen, TrendingUp, DollarSign, ShieldAlert, Zap } from 'lucide-react';

export function MoneyMasterclassSection() {
  return (
    <section aria-labelledby="money-guide-heading" className="glass-card rounded-3xl p-8 md:p-12 border border-blue-500/20 bg-slate-900/90 shadow-2xl space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
          <div className="w-10 h-10 rounded-xl bg-blue-500/10 text-cyan-400 flex items-center justify-center border border-blue-500/20">
            <TrendingUp className="w-5 h-5" />
          </div>
          <h3 className="font-bold text-white text-base">1. The 8-Minute Mid-Roll Rule</h3>
        ...
        <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
          ...
          <h3 className="font-bold text-white text-base">2. Commercial Keyword Targeting</h3>
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
          ...
          <h3 className="font-bold text-white text-base">3. Diversified Creator Income</h3>
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
