  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Daily Card */}
        <div className="glass-card rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 p-6 shadow-md dark:shadow-xl flex flex-col justify-between">
          ...
          <div className="font-mono text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white my-2">
        ...
        {/* Monthly Card */}
        <div className="glass-card rounded-3xl border border-cyan-300 dark:border-cyan-500/40 bg-gradient-to-br from-blue-50 via-cyan-50/50 to-white dark:from-blue-950/60 dark:via-slate-900/95 dark:to-slate-900/95 p-6 text-slate-900 dark:text-white shadow-xl dark:shadow-2xl shadow-cyan-500/10 flex flex-col justify-between">
          <div className="flex items-center justify-between gap-2 mb-2">
          ...
          <div className="font-mono text-3xl sm:text-4xl font-black text-slate-900 dark:text-white my-2">
      ...
      <div className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-xs font-medium text-slate-600 dark:text-slate-300 flex flex-col sm:flex-row items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-0.5 rounded-full bg-cyan-50 dark:bg-blue-500/10 text-cyan-700 dark:text-cyan-400 font-mono font-bold border border-cyan-200 dark:border-blue-500/30 text-[11px]">
            RPM Rate
          </span>
          <span>Calculated at <strong>${effectiveRpm.toFixed(2)} RPM</strong> (Net Take-Home per 1,000 views)</span>
        </div>
        {includeSponsorships && (
          <span className="text-emerald-600 dark:text-cyan-400 font-semibold">
